...
public class NewPostBuyFormSellerStruct implements java.io.Serializable {
    ...
    private int sellerGdId;

    private float sellerShipmentAmount;

    private String sellerMessageTo;
     ...
     * @param sellerGdId
     */
    public void setSellerGdId(int sellerGdId) {
        this.sellerGdId = sellerGdId;
    }
     ...
     */
    public void setSellerMessageTo(String sellerMessageTo) {
        this.sellerMessageTo = sellerMessageTo;
    }
    ...
    public synchronized boolean equals(Object obj) {
        ...
        _equals = true &&
                ...
                this.sellerGdId == other.getSellerGdId() &&
    ...
    public synchronized int hashCode() {
        ...
        if (getSellerItemIds() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getSellerItemIds(), i);
                if (obj != null &&
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "seller-gd-id"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
