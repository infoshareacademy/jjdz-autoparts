...
public class SysStatusType implements java.io.Serializable {
    ...
    private String catsVersion;

    private String apiVersion;

    private String attribVersion;

    private String formSellVersion;
    ...
    public SysStatusType(
            ...
            String catsVersion,
            String apiVersion,
            String attribVersion,
            String formSellVersion,
            String siteVersion,
            long verKey) {
     ...
     * @param catsVersion
     */
    public void setCatsVersion(String catsVersion) {
        this.catsVersion = catsVersion;
    }
     ...
     * @param attribVersion
     */
    public void setAttribVersion(String attribVersion) {
        this.attribVersion = attribVersion;
    }
     ...
     */
    public void setFormSellVersion(String formSellVersion) {
        this.formSellVersion = formSellVersion;
    }
