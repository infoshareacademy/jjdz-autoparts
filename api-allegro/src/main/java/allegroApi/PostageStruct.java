...
public class PostageStruct implements java.io.Serializable {
    ...
    private int postageFreeReturn;

    private allegroApi.FulfillmentTimeStruct postageFulfillmentTime;
    ...
    public PostageStruct(
            ...
            int postageFreeReturn,
            allegroApi.FulfillmentTimeStruct postageFulfillmentTime) {
     ...
     */
    public int getPostageFreeReturn() {
        return postageFreeReturn;
    }
     ...
     */
    public void setPostageFreeReturn(int postageFreeReturn) {
        this.postageFreeReturn = postageFreeReturn;
    }
     ...
     */
    public allegroApi.FulfillmentTimeStruct getPostageFulfillmentTime() {
        return postageFulfillmentTime;
    }
     ...
     */
    public void setPostageFulfillmentTime(allegroApi.FulfillmentTimeStruct postageFulfillmentTime) {
        this.postageFulfillmentTime = postageFulfillmentTime;
    }
    ...
    public synchronized boolean equals(Object obj) {
        ...
        _equals = true &&
                ...
                this.postageFreeReturn == other.getPostageFreeReturn() &&
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += getPostageFreeReturn();
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "postage-free-return"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
