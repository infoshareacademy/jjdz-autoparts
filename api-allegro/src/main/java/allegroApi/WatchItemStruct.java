...
public class WatchItemStruct implements java.io.Serializable {
    ...
    private allegroApi.ItemReminderStruct[] itemReminder;
    ...
    public WatchItemStruct(
            ...
            int itemPayuInfo,
            allegroApi.ItemReminderStruct[] itemReminder) {
        this.itemId = itemId;
     ...
     * @return itemReminder
     */
    public allegroApi.ItemReminderStruct[] getItemReminder() {
        return itemReminder;
    }
     ...
     * @param itemReminder
     */
    public void setItemReminder(allegroApi.ItemReminderStruct[] itemReminder) {
        this.itemReminder = itemReminder;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getItemReminder() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getItemReminder(), i);
                if (obj != null &&
                        !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
