...
public class SellerPaymentInfoStruct implements java.io.Serializable {
    private allegroApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoPza;

    private allegroApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoNonPza;

    public SellerPaymentInfoStruct() {
    }

    public SellerPaymentInfoStruct(
            allegroApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoPza,
            allegroApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoNonPza) {
     ...
     */
    public allegroApi.ShipmentPaymentInfoStruct[] getShipmentPaymentInfoPza() {
        return shipmentPaymentInfoPza;
    }
     ...
     */
    public void setShipmentPaymentInfoPza(allegroApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoPza) {
        this.shipmentPaymentInfoPza = shipmentPaymentInfoPza;
    }
     ...
     */
    public allegroApi.ShipmentPaymentInfoStruct[] getShipmentPaymentInfoNonPza() {
        return shipmentPaymentInfoNonPza;
    }
     ...
     */
    public void setShipmentPaymentInfoNonPza(allegroApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoNonPza) {
        this.shipmentPaymentInfoNonPza = shipmentPaymentInfoNonPza;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getShipmentPaymentInfoPza() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getShipmentPaymentInfoPza(), i);
                if (obj != null &&
        ...
        if (getShipmentPaymentInfoNonPza() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getShipmentPaymentInfoNonPza(), i);
                if (obj != null &&
                        !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
