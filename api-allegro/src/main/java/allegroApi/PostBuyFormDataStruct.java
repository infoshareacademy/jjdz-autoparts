...
public class PostBuyFormDataStruct implements java.io.Serializable {
    ...
    private allegroApi.PostBuyFormItemStruct[] postBuyFormItems;
    ...
    private String postBuyFormMsgToSeller;

    private PostBuyFormAddressStruct postBuyFormInvoiceData;

    private PostBuyFormAddressStruct postBuyFormShipmentAddress;

    private String postBuyFormPayType;

    private long postBuyFormPayId;

    private String postBuyFormPayStatus;

    private String postBuyFormDateInit;

    private String postBuyFormDateRecv;

    private String postBuyFormDateCancel;
    ...
    private String postBuyFormGdAdditionalInfo;

    private float postBuyFormPaymentAmount;

    private int postBuyFormSentBySeller;

    private String postBuyFormBuyerLogin;

    private String postBuyFormBuyerEmail;
    ...
    public PostBuyFormDataStruct(
            ...
            String postBuyFormGdAdditionalInfo,
            float postBuyFormPaymentAmount,
            int postBuyFormSentBySeller,
            String postBuyFormBuyerLogin,
            String postBuyFormBuyerEmail) {
     ...
     */
    public allegroApi.PostBuyFormItemStruct[] getPostBuyFormItems() {
        return postBuyFormItems;
    }
     ...
     */
    public void setPostBuyFormItems(allegroApi.PostBuyFormItemStruct[] postBuyFormItems) {
        this.postBuyFormItems = postBuyFormItems;
    }
     ...
     */
    public void setPostBuyFormMsgToSeller(String postBuyFormMsgToSeller) {
        this.postBuyFormMsgToSeller = postBuyFormMsgToSeller;
    }
     ...
     */
    public void setPostBuyFormPayType(String postBuyFormPayType) {
        this.postBuyFormPayType = postBuyFormPayType;
    }
     ...
     */
    public void setPostBuyFormPayStatus(String postBuyFormPayStatus) {
        this.postBuyFormPayStatus = postBuyFormPayStatus;
    }
     ...
     */
    public void setPostBuyFormDateInit(String postBuyFormDateInit) {
        this.postBuyFormDateInit = postBuyFormDateInit;
    }
     ...
     */
    public void setPostBuyFormDateRecv(String postBuyFormDateRecv) {
        this.postBuyFormDateRecv = postBuyFormDateRecv;
    }
     ...
     */
    public void setPostBuyFormDateCancel(String postBuyFormDateCancel) {
        this.postBuyFormDateCancel = postBuyFormDateCancel;
    }
     ...
     */
    public void setPostBuyFormGdAdditionalInfo(String postBuyFormGdAdditionalInfo) {
        this.postBuyFormGdAdditionalInfo = postBuyFormGdAdditionalInfo;
    }
     ...
     */
    public void setPostBuyFormBuyerLogin(String postBuyFormBuyerLogin) {
        this.postBuyFormBuyerLogin = postBuyFormBuyerLogin;
    }
     ...
     */
    public void setPostBuyFormBuyerEmail(String postBuyFormBuyerEmail) {
        this.postBuyFormBuyerEmail = postBuyFormBuyerEmail;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPostBuyFormItems() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getPostBuyFormItems(), i);
                if (obj != null &&
        ...
        if (getPostBuyFormShipmentTracking() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getPostBuyFormShipmentTracking(), i);
                if (obj != null &&
                        !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
        ...
        if (getPostBuyFormSurchargesList() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getPostBuyFormSurchargesList(), i);
                if (obj != null &&
                        !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "post-buy-form-buyer-login"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("postBuyFormBuyerEmail");
        elemField.setXmlName(new javax.xml.namespace.QName("", "post-buy-form-buyer-email"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
