...
public class StructSellFailed implements java.io.Serializable {
    ...
    private String sellFaultCode;

    private String sellFaultString;
    ...
    public StructSellFailed(
            long sellItemId,
            String sellFaultCode,
            String sellFaultString) {
     ...
     * @param sellFaultCode
     */
    public void setSellFaultCode(String sellFaultCode) {
        this.sellFaultCode = sellFaultCode;
    }
     ...
     */
    public void setSellFaultString(String sellFaultString) {
        this.sellFaultString = sellFaultString;
    }
