...
public class SellRatingInfoStruct implements java.io.Serializable {
    ...
    private allegroApi.SellRatingReasonStruct[] sellRatingReasons;
    ...
    public SellRatingInfoStruct(
            ...
            allegroApi.SellRatingReasonStruct[] sellRatingReasons) {
     ...
     */
    public allegroApi.SellRatingReasonStruct[] getSellRatingReasons() {
        return sellRatingReasons;
    }
     ...
     */
    public void setSellRatingReasons(allegroApi.SellRatingReasonStruct[] sellRatingReasons) {
        this.sellRatingReasons = sellRatingReasons;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSellRatingReasons() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getSellRatingReasons(), i);
                if (obj != null &&
