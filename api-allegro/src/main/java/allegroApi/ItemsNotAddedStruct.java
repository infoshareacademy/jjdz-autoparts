...
public class ItemsNotAddedStruct implements java.io.Serializable {
    ...
    private String itemErrorDescription;
     ...
     * @param itemErrorCode
     */
    public void setItemErrorCode(String itemErrorCode) {
        this.itemErrorCode = itemErrorCode;
    }
     ...
     */
    public void setItemErrorDescription(String itemErrorDescription) {
        this.itemErrorDescription = itemErrorDescription;
    }
