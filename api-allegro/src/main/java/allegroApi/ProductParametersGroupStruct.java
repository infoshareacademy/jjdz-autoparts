...
public class ProductParametersGroupStruct implements java.io.Serializable {
    private String productParametersGroupName;
    ...
    public ProductParametersGroupStruct(
            String productParametersGroupName,
     ...
     */
    public void setProductParametersGroupName(String productParametersGroupName) {
        this.productParametersGroupName = productParametersGroupName;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getProductParametersList() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getProductParametersList(), i);
                if (obj != null &&
