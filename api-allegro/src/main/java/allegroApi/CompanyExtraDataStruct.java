...
public class CompanyExtraDataStruct implements java.io.Serializable {
    ...
    private String companyKrs;

    private String companyActivitySort;
     ...
     * @param companyKrs
     */
    public void setCompanyKrs(String companyKrs) {
        this.companyKrs = companyKrs;
    }
     ...
     */
    public void setCompanyActivitySort(String companyActivitySort) {
        this.companyActivitySort = companyActivitySort;
    }
