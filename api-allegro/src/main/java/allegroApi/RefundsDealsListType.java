...
public class RefundsDealsListType implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:AllegroWebApi", "RefundsDealsListType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "time-left"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "payment-status"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
