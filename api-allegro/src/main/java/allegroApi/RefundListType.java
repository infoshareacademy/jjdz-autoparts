...
public class RefundListType implements java.io.Serializable {
    ...
    private allegroApi.RefundDetailsType refundDetails;
    ...
    public RefundListType(
            ...
            int bidsCount,
            String quantityType,
            allegroApi.RefundDetailsType refundDetails) {
        this.dealId = dealId;
     ...
     */
    public allegroApi.RefundDetailsType getRefundDetails() {
        return refundDetails;
    }
     ...
     * @param refundDetails
     */
    public void setRefundDetails(allegroApi.RefundDetailsType refundDetails) {
        this.refundDetails = refundDetails;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:AllegroWebApi", "RefundListType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "buyer-login"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "bids-count"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("quantityType");
        elemField.setXmlName(new javax.xml.namespace.QName("", "quantity-type"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("refundDetails");
        elemField.setXmlName(new javax.xml.namespace.QName("", "refund-details"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:AllegroWebApi", "RefundDetailsType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
