...
public class TransactionPayByLinkStruct implements java.io.Serializable {
    ...
    private allegroApi.ActionDataStruct[] actionData;
    ...
    public TransactionPayByLinkStruct(
            ...
            String actionUrl,
            allegroApi.ActionDataStruct[] actionData) {
     ...
     * @return actionData
     */
    public allegroApi.ActionDataStruct[] getActionData() {
        return actionData;
    }
     ...
     * @param actionData
     */
    public void setActionData(allegroApi.ActionDataStruct[] actionData) {
        this.actionData = actionData;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getActionData() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getActionData(), i);
                if (obj != null &&
