...
public class SellRatingAveragePerMonthStruct implements java.io.Serializable {
    private String sellRatingMonth;
     ...
     */
    public void setSellRatingMonth(String sellRatingMonth) {
        this.sellRatingMonth = sellRatingMonth;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSellRatingAverageValues() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getSellRatingAverageValues(), i);
                if (obj != null &&
