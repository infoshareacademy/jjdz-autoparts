...
public class AddressInfoStruct implements java.io.Serializable {
    ...
    private allegroApi.AddressUserDataStruct addressUserData;
    ...
    public AddressInfoStruct(
            int addressType,
            allegroApi.AddressUserDataStruct addressUserData) {
     ...
     */
    public allegroApi.AddressUserDataStruct getAddressUserData() {
        return addressUserData;
    }
     ...
     */
    public void setAddressUserData(allegroApi.AddressUserDataStruct addressUserData) {
        this.addressUserData = addressUserData;
    }
