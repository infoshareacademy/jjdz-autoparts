...
public class FeedbackManyStruct implements java.io.Serializable {
    ...
    private String feCommentType;

    private int feOp;

    private allegroApi.SellRatingEstimationStruct[] feRating;
    ...
    public FeedbackManyStruct(
            ...
            int feToUserId,
            String feComment,
            String feCommentType,
            int feOp,
            allegroApi.SellRatingEstimationStruct[] feRating) {
     ...
     * @param feCommentType
     */
    public void setFeCommentType(String feCommentType) {
        this.feCommentType = feCommentType;
    }
     ...
     * @return feRating
     */
    public allegroApi.SellRatingEstimationStruct[] getFeRating() {
        return feRating;
    }
     ...
     * @param feRating
     */
    public void setFeRating(allegroApi.SellRatingEstimationStruct[] feRating) {
        this.feRating = feRating;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getFeRating() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getFeRating(), i);
                if (obj != null &&
