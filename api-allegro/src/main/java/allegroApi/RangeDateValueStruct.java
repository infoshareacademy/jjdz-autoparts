...
public class RangeDateValueStruct implements java.io.Serializable {
    private String fvalueRangeDateMin;

    private String fvalueRangeDateMax;

    public RangeDateValueStruct() {
    }

    public RangeDateValueStruct(
            String fvalueRangeDateMin,
            String fvalueRangeDateMax) {
     ...
     */
    public void setFvalueRangeDateMin(String fvalueRangeDateMin) {
        this.fvalueRangeDateMin = fvalueRangeDateMin;
    }
     ...
     */
    public void setFvalueRangeDateMax(String fvalueRangeDateMax) {
        this.fvalueRangeDateMax = fvalueRangeDateMax;
    }
