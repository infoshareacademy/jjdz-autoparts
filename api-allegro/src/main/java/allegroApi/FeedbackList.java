...
public class FeedbackList implements java.io.Serializable {
    ...
    private String fCorrectText;

    private String fReceiverType;

    private String fUserLogin;

    private String fUserRating;

    private String fUserCountry;
     ...
     * @param fCorrectText
     */
    public void setFCorrectText(String fCorrectText) {
        this.fCorrectText = fCorrectText;
    }
     ...
     * @param fReceiverType
     */
    public void setFReceiverType(String fReceiverType) {
        this.fReceiverType = fReceiverType;
    }
     ...
     * @param fUserLogin
     */
    public void setFUserLogin(String fUserLogin) {
        this.fUserLogin = fUserLogin;
    }
     ...
     * @param fUserRating
     */
    public void setFUserRating(String fUserRating) {
        this.fUserRating = fUserRating;
    }
     ...
     * @param fUserCountry
     */
    public void setFUserCountry(String fUserCountry) {
        this.fUserCountry = fUserCountry;
    }
