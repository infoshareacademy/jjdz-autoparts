...
public class InvoiceInfoStruct implements java.io.Serializable {
    ...
    private allegroApi.AddressUserDataStruct invoiceAddressData;
    ...
    public InvoiceInfoStruct(
            ...
            allegroApi.AddressUserDataStruct invoiceAddressData,
            String invoiceNip) {
     ...
     */
    public allegroApi.AddressUserDataStruct getInvoiceAddressData() {
        return invoiceAddressData;
    }
     ...
     */
    public void setInvoiceAddressData(allegroApi.AddressUserDataStruct invoiceAddressData) {
        this.invoiceAddressData = invoiceAddressData;
    }
