...
public class ItemPostBuyDataStruct implements java.io.Serializable {
    ...
    private allegroApi.UserPostBuyDataStruct[] usersPostBuyData;
    ...
    public ItemPostBuyDataStruct(
            long itemId,
            allegroApi.UserPostBuyDataStruct[] usersPostBuyData) {
        this.itemId = itemId;
     ...
     */
    public allegroApi.UserPostBuyDataStruct[] getUsersPostBuyData() {
        return usersPostBuyData;
    }
     ...
     */
    public void setUsersPostBuyData(allegroApi.UserPostBuyDataStruct[] usersPostBuyData) {
        this.usersPostBuyData = usersPostBuyData;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getUsersPostBuyData() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getUsersPostBuyData(), i);
                if (obj != null &&
