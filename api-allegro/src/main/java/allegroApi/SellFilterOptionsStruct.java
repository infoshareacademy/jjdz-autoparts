...
public class SellFilterOptionsStruct implements java.io.Serializable {
    ...
    private allegroApi.FilterPriceStruct filterPrice;
    ...
    public SellFilterOptionsStruct(
            ...
            allegroApi.FilterPriceStruct filterPrice,
     ...
     * @return filterPrice
     */
    public allegroApi.FilterPriceStruct getFilterPrice() {
        return filterPrice;
    }
     ...
     * @param filterPrice
     */
    public void setFilterPrice(allegroApi.FilterPriceStruct filterPrice) {
        this.filterPrice = filterPrice;
    }
