...
public class RelatedItemsShipmentDataStruct implements java.io.Serializable {
    private allegroApi.SellerShipmentDataStruct[] sellerShipmentData;

    public RelatedItemsShipmentDataStruct() {
    }

    public RelatedItemsShipmentDataStruct(
            allegroApi.SellerShipmentDataStruct[] sellerShipmentData) {
     ...
     */
    public allegroApi.SellerShipmentDataStruct[] getSellerShipmentData() {
        return sellerShipmentData;
    }
     ...
     */
    public void setSellerShipmentData(allegroApi.SellerShipmentDataStruct[] sellerShipmentData) {
        this.sellerShipmentData = sellerShipmentData;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSellerShipmentData() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getSellerShipmentData(), i);
                if (obj != null &&
