...
public class WaitFeedbackStruct implements java.io.Serializable {
    ...
    private String feItemName;

    private int feToUserId;

    private int feOp;

    private String feAnsCommentType;
     ...
     * @param feItemName
     */
    public void setFeItemName(String feItemName) {
        this.feItemName = feItemName;
    }
     ...
     */
    public void setFeAnsCommentType(String feAnsCommentType) {
        this.feAnsCommentType = feAnsCommentType;
    }
