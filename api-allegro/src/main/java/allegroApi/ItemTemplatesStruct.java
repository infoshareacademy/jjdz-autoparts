...
public class ItemTemplatesStruct implements java.io.Serializable {
    private allegroApi.ItemTemplateListStruct[] itemTemplateList;
    ...
    public ItemTemplatesStruct(
            allegroApi.ItemTemplateListStruct[] itemTemplateList,
     ...
     */
    public allegroApi.ItemTemplateListStruct[] getItemTemplateList() {
        return itemTemplateList;
    }
     ...
     */
    public void setItemTemplateList(allegroApi.ItemTemplateListStruct[] itemTemplateList) {
        this.itemTemplateList = itemTemplateList;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getItemTemplateList() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getItemTemplateList(), i);
                if (obj != null &&
        ...
        if (getItemTemplateIncorrectIds() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getItemTemplateIncorrectIds(), i);
                if (obj != null &&
                        !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
