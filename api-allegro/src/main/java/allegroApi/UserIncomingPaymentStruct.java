...
public class UserIncomingPaymentStruct implements java.io.Serializable {
    ...
    private allegroApi.PaymentDetailsStruct[] payTransDetails;
    ...
    public UserIncomingPaymentStruct(
            ...
            allegroApi.PaymentDetailsStruct[] payTransDetails,
     ...
     */
    public void setPayTransStatus(String payTransStatus) {
        this.payTransStatus = payTransStatus;
    }
     ...
     */
    public allegroApi.PaymentDetailsStruct[] getPayTransDetails() {
        return payTransDetails;
    }
     ...
     */
    public void setPayTransDetails(allegroApi.PaymentDetailsStruct[] payTransDetails) {
        this.payTransDetails = payTransDetails;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPayTransDetails() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getPayTransDetails(), i);
                if (obj != null &&
