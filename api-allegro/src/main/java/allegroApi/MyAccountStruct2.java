...
public class MyAccountStruct2 implements java.io.Serializable {
    private String[] myAccountArray;

    public MyAccountStruct2() {
    }

    public MyAccountStruct2(
            String[] myAccountArray) {
     ...
     */
    public String[] getMyAccountArray() {
        return myAccountArray;
    }
     ...
     */
    public void setMyAccountArray(String[] myAccountArray) {
        this.myAccountArray = myAccountArray;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getMyAccountArray() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getMyAccountArray(), i);
                if (obj != null &&
