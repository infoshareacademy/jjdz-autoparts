...
public class ChangedItemStruct implements java.io.Serializable {
    ...
    private allegroApi.FieldsValue[] itemFields;

    private allegroApi.ItemSurchargeStruct[] itemSurcharge;
    ...
    public ChangedItemStruct(
            long itemId,
            allegroApi.FieldsValue[] itemFields,
            allegroApi.ItemSurchargeStruct[] itemSurcharge) {
        this.itemId = itemId;
     ...
     * @return itemFields
     */
    public allegroApi.FieldsValue[] getItemFields() {
        return itemFields;
    }
     ...
     * @param itemFields
     */
    public void setItemFields(allegroApi.FieldsValue[] itemFields) {
        this.itemFields = itemFields;
    }
     ...
     */
    public allegroApi.ItemSurchargeStruct[] getItemSurcharge() {
        return itemSurcharge;
    }
     ...
     * @param itemSurcharge
     */
    public void setItemSurcharge(allegroApi.ItemSurchargeStruct[] itemSurcharge) {
        this.itemSurcharge = itemSurcharge;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getItemFields() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getItemFields(), i);
                if (obj != null &&
        ...
        if (getItemSurcharge() != null) {
            for (int i = 0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getItemSurcharge(), i);
                if (obj != null &&
                        !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
