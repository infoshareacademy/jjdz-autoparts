...
public class UserBlackListAddResultStruct implements java.io.Serializable {
    ...
    private String addToBlackListErrCode;

    private String addToBlackListErrMsg;
    ...
    public UserBlackListAddResultStruct(
            ...
            String addToBlackListErrCode,
            String addToBlackListErrMsg) {
        this.userId = userId;
     ...
     */
    public void setAddToBlackListErrCode(String addToBlackListErrCode) {
        this.addToBlackListErrCode = addToBlackListErrCode;
    }
     ...
     */
    public void setAddToBlackListErrMsg(String addToBlackListErrMsg) {
        this.addToBlackListErrMsg = addToBlackListErrMsg;
    }
