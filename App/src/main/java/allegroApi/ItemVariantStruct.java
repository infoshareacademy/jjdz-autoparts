...
public class ItemVariantStruct implements java.io.Serializable {
    ...
    private allegroApi.ItemVariantAttributeStruct[] attributes;
    ...
    public ItemVariantStruct(
            java.lang.String id,
            int quantity,
            allegroApi.ItemVariantAttributeStruct[] attributes) {
        this.id = id;
     ...
     * @return attributes
     */
    public allegroApi.ItemVariantAttributeStruct[] getAttributes() {
        return attributes;
    }
     ...
     * @param attributes
     */
    public void setAttributes(allegroApi.ItemVariantAttributeStruct[] attributes) {
        this.attributes = attributes;
    }
