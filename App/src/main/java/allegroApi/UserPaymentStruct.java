...
public class UserPaymentStruct implements java.io.Serializable {
    ...
    private allegroApi.PaymentSellersStruct[] payTransSellers;
    ...
    public UserPaymentStruct(
            long payTransId,
            allegroApi.PaymentSellersStruct[] payTransSellers,
     ...
     */
    public allegroApi.PaymentSellersStruct[] getPayTransSellers() {
        return payTransSellers;
    }
     ...
     */
    public void setPayTransSellers(allegroApi.PaymentSellersStruct[] payTransSellers) {
        this.payTransSellers = payTransSellers;
    }
