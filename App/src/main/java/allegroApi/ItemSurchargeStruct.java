...
public class ItemSurchargeStruct implements java.io.Serializable {
    ...
    private allegroApi.AmountStruct surchargeAmount;
    ...
    public ItemSurchargeStruct(
            ...
            allegroApi.AmountStruct surchargeAmount) {
     ...
     */
    public allegroApi.AmountStruct getSurchargeAmount() {
        return surchargeAmount;
    }
     ...
     */
    public void setSurchargeAmount(allegroApi.AmountStruct surchargeAmount) {
        this.surchargeAmount = surchargeAmount;
    }
