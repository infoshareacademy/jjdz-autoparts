...
public class SellFormFieldsForCategoryStruct implements java.io.Serializable {
    private allegroApi.SellFormType[] sellFormFieldsList;
    ...
    public SellFormFieldsForCategoryStruct(
            allegroApi.SellFormType[] sellFormFieldsList,
     ...
     */
    public allegroApi.SellFormType[] getSellFormFieldsList() {
        return sellFormFieldsList;
    }
     ...
     */
    public void setSellFormFieldsList(allegroApi.SellFormType[] sellFormFieldsList) {
        this.sellFormFieldsList = sellFormFieldsList;
    }
