...
public class PaymentSellersStruct implements java.io.Serializable {
    ...
    private allegroApi.PaymentItemsStruct[] payTransItems;
    ...
    public PaymentSellersStruct(
            ...
            allegroApi.PaymentItemsStruct[] payTransItems,
     ...
     */
    public allegroApi.PaymentItemsStruct[] getPayTransItems() {
        return payTransItems;
    }
     ...
     * @param payTransItems
     */
    public void setPayTransItems(allegroApi.PaymentItemsStruct[] payTransItems) {
        this.payTransItems = payTransItems;
    }
