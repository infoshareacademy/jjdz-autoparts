...
public class PaymentsPayoutStruct implements java.io.Serializable {
    ...
    private allegroApi.PayoutAutoSettingsStruct payoutAutoSettings;
    ...
    public PaymentsPayoutStruct(
            int payoutType,
            allegroApi.PayoutAutoSettingsStruct payoutAutoSettings) {
     ...
     */
    public allegroApi.PayoutAutoSettingsStruct getPayoutAutoSettings() {
        return payoutAutoSettings;
    }
     ...
     */
    public void setPayoutAutoSettings(allegroApi.PayoutAutoSettingsStruct payoutAutoSettings) {
        this.payoutAutoSettings = payoutAutoSettings;
    }
