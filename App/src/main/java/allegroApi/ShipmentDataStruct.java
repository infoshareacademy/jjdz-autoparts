...
public class ShipmentDataStruct implements java.io.Serializable {
    ...
    private allegroApi.ShipmentTimeStruct shipmentTime;
    ...
    public ShipmentDataStruct(
            ...
            int shipmentType,
            allegroApi.ShipmentTimeStruct shipmentTime) {
     ...
     * @return shipmentTime
     */
    public allegroApi.ShipmentTimeStruct getShipmentTime() {
        return shipmentTime;
    }
     ...
     * @param shipmentTime
     */
    public void setShipmentTime(allegroApi.ShipmentTimeStruct shipmentTime) {
        this.shipmentTime = shipmentTime;
    }
