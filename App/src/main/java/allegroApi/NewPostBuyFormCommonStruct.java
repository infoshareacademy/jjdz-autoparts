...
public class NewPostBuyFormCommonStruct implements java.io.Serializable {
    ...
    private allegroApi.AddressUserDataStruct shipmentAddressData;

    private java.lang.String contactPhone;

    private int invoiceOption;

    private allegroApi.InvoiceInfoStruct invoiceInfo;
    ...
    public NewPostBuyFormCommonStruct(
            ...
            allegroApi.AddressUserDataStruct shipmentAddressData,
            java.lang.String contactPhone,
            int invoiceOption,
            allegroApi.InvoiceInfoStruct invoiceInfo) {
     ...
     */
    public allegroApi.AddressUserDataStruct getShipmentAddressData() {
        return shipmentAddressData;
    }
     ...
     */
    public void setShipmentAddressData(allegroApi.AddressUserDataStruct shipmentAddressData) {
        this.shipmentAddressData = shipmentAddressData;
    }
     ...
     * @return invoiceInfo
     */
    public allegroApi.InvoiceInfoStruct getInvoiceInfo() {
        return invoiceInfo;
    }
     ...
     * @param invoiceInfo
     */
    public void setInvoiceInfo(allegroApi.InvoiceInfoStruct invoiceInfo) {
        this.invoiceInfo = invoiceInfo;
    }
