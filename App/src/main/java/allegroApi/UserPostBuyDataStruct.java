...
public class UserPostBuyDataStruct implements java.io.Serializable {
    private allegroApi.UserDataStruct userData;

    private allegroApi.UserSentToDataStruct userSentToData;

    private java.lang.String[] userBankAccounts;

    private allegroApi.CompanySecondAddressStruct companySecondAddress;

    public UserPostBuyDataStruct() {
    }

    public UserPostBuyDataStruct(
            allegroApi.UserDataStruct userData,
            allegroApi.UserSentToDataStruct userSentToData,
            java.lang.String[] userBankAccounts,
            allegroApi.CompanySecondAddressStruct companySecondAddress) {
     ...
     * @return userData
     */
    public allegroApi.UserDataStruct getUserData() {
        return userData;
    }
     ...
     * @param userData
     */
    public void setUserData(allegroApi.UserDataStruct userData) {
        this.userData = userData;
    }
     ...
     */
    public allegroApi.UserSentToDataStruct getUserSentToData() {
        return userSentToData;
    }
     ...
     */
    public void setUserSentToData(allegroApi.UserSentToDataStruct userSentToData) {
        this.userSentToData = userSentToData;
    }
     ...
     */
    public allegroApi.CompanySecondAddressStruct getCompanySecondAddress() {
        return companySecondAddress;
    }
     ...
     */
    public void setCompanySecondAddress(allegroApi.CompanySecondAddressStruct companySecondAddress) {
        this.companySecondAddress = companySecondAddress;
    }
