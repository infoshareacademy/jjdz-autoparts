...
public class WatchListInfoStruct implements java.io.Serializable {
    ...
    private allegroApi.ItemsNotAddedStruct[] itemsNotAdded;
    ...
    public WatchListInfoStruct(
            long[] itemsAdded,
            allegroApi.ItemsNotAddedStruct[] itemsNotAdded) {
     ...
     */
    public allegroApi.ItemsNotAddedStruct[] getItemsNotAdded() {
        return itemsNotAdded;
    }
     ...
     * @param itemsNotAdded
     */
    public void setItemsNotAdded(allegroApi.ItemsNotAddedStruct[] itemsNotAdded) {
        this.itemsNotAdded = itemsNotAdded;
    }
