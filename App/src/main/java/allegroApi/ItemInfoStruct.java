...
public class ItemInfoStruct implements java.io.Serializable {
    private allegroApi.ItemInfo itemInfo;

    private allegroApi.ItemCatList[] itemCats;

    private allegroApi.ItemImageList[] itemImages;

    private allegroApi.AttribStruct[] itemAttribs;

    private allegroApi.PostageStruct[] itemPostageOptions;

    private allegroApi.ItemPaymentOptions itemPaymentOptions;

    private allegroApi.CompanyInfoStruct itemCompanyInfo;

    private allegroApi.ProductStruct itemProductInfo;

    public ItemInfoStruct() {
    }

    public ItemInfoStruct(
            allegroApi.ItemInfo itemInfo,
            allegroApi.ItemCatList[] itemCats,
            allegroApi.ItemImageList[] itemImages,
            allegroApi.AttribStruct[] itemAttribs,
            allegroApi.PostageStruct[] itemPostageOptions,
            allegroApi.ItemPaymentOptions itemPaymentOptions,
            allegroApi.CompanyInfoStruct itemCompanyInfo,
            allegroApi.ProductStruct itemProductInfo) {
     ...
     * @return itemInfo
     */
    public allegroApi.ItemInfo getItemInfo() {
        return itemInfo;
    }
     ...
     * @param itemInfo
     */
    public void setItemInfo(allegroApi.ItemInfo itemInfo) {
        this.itemInfo = itemInfo;
    }
     ...
     * @return itemCats
     */
    public allegroApi.ItemCatList[] getItemCats() {
        return itemCats;
    }
     ...
     * @param itemCats
     */
    public void setItemCats(allegroApi.ItemCatList[] itemCats) {
        this.itemCats = itemCats;
    }
     ...
     * @return itemImages
     */
    public allegroApi.ItemImageList[] getItemImages() {
        return itemImages;
    }
     ...
     * @param itemImages
     */
    public void setItemImages(allegroApi.ItemImageList[] itemImages) {
        this.itemImages = itemImages;
    }
     ...
     * @return itemAttribs
     */
    public allegroApi.AttribStruct[] getItemAttribs() {
        return itemAttribs;
    }
     ...
     * @param itemAttribs
     */
    public void setItemAttribs(allegroApi.AttribStruct[] itemAttribs) {
        this.itemAttribs = itemAttribs;
    }
     ...
     */
    public allegroApi.PostageStruct[] getItemPostageOptions() {
        return itemPostageOptions;
    }
     ...
     */
    public void setItemPostageOptions(allegroApi.PostageStruct[] itemPostageOptions) {
        this.itemPostageOptions = itemPostageOptions;
    }
     ...
     */
    public allegroApi.ItemPaymentOptions getItemPaymentOptions() {
        return itemPaymentOptions;
    }
     ...
     */
    public void setItemPaymentOptions(allegroApi.ItemPaymentOptions itemPaymentOptions) {
        this.itemPaymentOptions = itemPaymentOptions;
    }
     ...
     */
    public allegroApi.ProductStruct getItemProductInfo() {
        return itemProductInfo;
    }
     ...
     */
    public void setItemProductInfo(allegroApi.ProductStruct itemProductInfo) {
        this.itemProductInfo = itemProductInfo;
    }
