...
public class PostBuyItemInfoStruct implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:AllegroWebApi", "PostBuyItemInfoStruct"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "item-post-buy-form-info"));
