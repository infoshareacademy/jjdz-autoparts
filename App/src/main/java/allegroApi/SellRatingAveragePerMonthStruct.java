...
public class SellRatingAveragePerMonthStruct implements java.io.Serializable {
    ...
    private allegroApi.SellRatingStatsStruct[] sellRatingAverageValues;
    ...
    public SellRatingAveragePerMonthStruct(
            ...
            allegroApi.SellRatingStatsStruct[] sellRatingAverageValues) {
     ...
     */
    public allegroApi.SellRatingStatsStruct[] getSellRatingAverageValues() {
        return sellRatingAverageValues;
    }
     ...
     */
    public void setSellRatingAverageValues(allegroApi.SellRatingStatsStruct[] sellRatingAverageValues) {
        this.sellRatingAverageValues = sellRatingAverageValues;
    }
