...
public class FilterOptionsType implements java.io.Serializable {
    ...
    private allegroApi.RangeValueType filterValueRange;
    ...
    public FilterOptionsType(
            ...
            allegroApi.RangeValueType filterValueRange) {
     ...
     */
    public allegroApi.RangeValueType getFilterValueRange() {
        return filterValueRange;
    }
     ...
     */
    public void setFilterValueRange(allegroApi.RangeValueType filterValueRange) {
        this.filterValueRange = filterValueRange;
    }
