...
public class RelatedItemsStruct implements java.io.Serializable {
    private allegroApi.RelatedItemStruct[] relatedItemsInfo;
    ...
    public RelatedItemsStruct(
            allegroApi.RelatedItemStruct[] relatedItemsInfo,
     ...
     */
    public allegroApi.RelatedItemStruct[] getRelatedItemsInfo() {
        return relatedItemsInfo;
    }
     ...
     */
    public void setRelatedItemsInfo(allegroApi.RelatedItemStruct[] relatedItemsInfo) {
        this.relatedItemsInfo = relatedItemsInfo;
    }
